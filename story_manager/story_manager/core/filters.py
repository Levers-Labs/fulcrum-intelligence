...
class StoryFilter(BaseFilter[Story]):
    ...
    created_at_start: datetime | None = FilterField(Story.story_date, operator="ge", default=None)  # type: ignore
    created_at_end: datetime | None = FilterField(Story.story_date, operator="le", default=None)  # type: ignore
