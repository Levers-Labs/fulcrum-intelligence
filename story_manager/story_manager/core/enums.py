...
class StoryType(str, Enum):
    ...
    # Trend Genre - Trend Exceptions Stories
    SPIKE = "SPIKE"
    DROP = "DROP"
    ...
    NEW_STRONGEST_SEGMENT = "NEW_STRONGEST_SEGMENT"
    NEW_WEAKEST_SEGMENT = "NEW_WEAKEST_SEGMENT"
    NEW_LARGEST_SEGMENT = "NEW_LARGEST_SEGMENT"
    NEW_SMALLEST_SEGMENT = "NEW_SMALLEST_SEGMENT"
    # Performance Stories
    ON_TRACK = "ON_TRACK"
    OFF_TRACK = "OFF_TRACK"
    ...
    FORECASTED_ON_TRACK = "FORECASTED_ON_TRACK"
    FORECASTED_OFF_TRACK = "FORECASTED_OFF_TRACK"
    PACING_ON_TRACK = "PACING_ON_TRACK"
    PACING_OFF_TRACK = "PACING_OFF_TRACK"
    # Root Causes Genre - Segment Drift Stories
    ...
    # Root Causes Genre - Influence Drift Stories TODO: once we are ready to completely discontinue v1 stories,
    #  we need to update STRONGER/WEAKER_INFLUENCE to STRONGER_INFLUENCE_RELATIONSHIP/WEAKER_INFLUENCE_RELATIONSHIP
    #  we need to update IMPROVING_INFLUENCE/WORSENING_INFLUENCE to
    #  IMPROVING_INFLUENCE_METRIC/WORSENING_INFLUENCE_METRIC
    ...
    # Root Causes Genre - Component Drift Stories
    IMPROVING_COMPONENT = "IMPROVING_COMPONENT"
    WORSENING_COMPONENT = "WORSENING_COMPONENT"
    # Root Causes Genre - Root Causes Summary Stories
    PRIMARY_ROOT_CAUSE_FACTOR = "PRIMARY_ROOT_CAUSE_FACTOR"
    # Headwinds/Tailwinds Genre - Leading Indicators Stories
    UNFAVORABLE_DRIVER_TREND = "UNFAVORABLE_DRIVER_TREND"
    FAVORABLE_DRIVER_TREND = "FAVORABLE_DRIVER_TREND"
    # Headwinds/Tailwinds Genre - Seasonality Stories
    UNFAVORABLE_SEASONAL_TREND = "UNFAVORABLE_SEASONAL_TREND"
    FAVORABLE_SEASONAL_TREND = "FAVORABLE_SEASONAL_TREND"
    # Headwinds/Tailwinds Genre - Risk Stories
    VOLATILITY_ALERT = "VOLATILITY_ALERT"
    CONCENTRATION_RISK = "CONCENTRATION_RISK"
    # Performance Genre - Overall GVA and Performance Stories
    PORTFOLIO_STATUS_OVERVIEW = "PORTFOLIO_STATUS_OVERVIEW"
    PORTFOLIO_PERFORMANCE_OVERVIEW = "PORTFOLIO_PERFORMANCE_OVERVIEW"
...
class StoryGroup(str, Enum):
    ...
    # Headwinds/Tailwinds Groups
    HEADWIND_LEADING_INDICATORS = "HEADWIND_LEADING_INDICATORS"
    TAILWIND_LEADING_INDICATORS = "TAILWIND_LEADING_INDICATORS"
    HEADWIND_SEASONALITY = "HEADWIND_SEASONALITY"
    TAILWIND_SEASONALITY = "TAILWIND_SEASONALITY"
    RISK_VOLATILITY = "RISK_VOLATILITY"
    RISK_CONCENTRATION = "RISK_CONCENTRATION"

    OVERALL_GVA = "OVERALL_GVA"
