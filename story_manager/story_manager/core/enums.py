...
STORY_TYPES_META: dict[str, dict[str, str]] = {
    ...
    StoryType.NEW_UPWARD_TREND: {
        ...
        "template": "Since {start_date}, {metric} has been averaging {current_growth}% {grain_comp} growth -- "
        "an increase over its average of {prior_growth}% {grain_comp} growth from {start_date} to "
        "{end_date}.",
    },
    StoryType.NEW_DOWNWARD_TREND: {
        ...
        "pattern expected to continue into the future.",
        "template": "Since {start_date}, {metric} has been averaging {current_growth}% {grain_comp} growth -- "
        "a decrease over its average of {prior_growth}% {grain_comp} growth from {start_date} to "
        "{end_date}.",
    },
    StoryType.STICKY_DOWNWARD_TREND: {
        ...
        "averaging {current_growth}% {grain_comp} decrease.",
    },
    StoryType.NEW_NORMAL: {
        "label": "New Normal",
        ...
        "{current_growth}% [up|down] {prior_growth}% from the previous normal of {previous_normal}. "
        "The prior 'normal' lasted {prior_normal_days} days.",
    },
    StoryType.RECORD_HIGH: {
        "label": "Record High",
