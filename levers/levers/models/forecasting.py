...
class StatisticalForecast(BaseModel):
    """Model for statistical forecast information."""
...
class PacingProjection(BaseModel):
    ...
    current_cumulative_value: float | None = None
...
class RequiredPerformance(BaseModel):
    ...
    remaining_grains_count: int | None = None
...
class DailyForecast(BaseModel):
    """Model for daily forecast information."""
