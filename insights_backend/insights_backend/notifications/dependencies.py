...
from insights_backend.notifications.services.notification_listing_service import NotificationListService
...
async def get_notification_list_service(
    ...
    return NotificationListService(alert_crud=alert_crud)
