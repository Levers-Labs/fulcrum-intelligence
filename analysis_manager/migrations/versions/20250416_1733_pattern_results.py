...
def upgrade() -> None:
    ...
    # Create granularity enum in a safer way - reuse if it exists
    granularity_enum = postgresql.ENUM(
        "DAY",
        "WEEK",
        "MONTH",
        "QUARTER",
        "YEAR",
        name="granularity",
        create_type=False,  # Don't try to create the type as part of the table creation
    )
