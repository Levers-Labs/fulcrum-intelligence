...
Revision ID: ac90cb279076
Revises:
Create Date: 2024-06-18 08:54:34.807925
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("evaluation_value", sa.Float(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("current_timestamp(0)"), nullable=False),
        sa.Column("updated_at", sa.DateTime(), server_default=sa.text("current_timestamp(0)"), nullable=False),
        sa.Column("absolute_drift", sa.Float(), nullable=False),
        sa.Column("percentage_drift", sa.Float(), nullable=False),
        sa.Column("relative_impact", sa.Float(), nullable=False),
        sa.Column("marginal_contribution", sa.Float(), nullable=False),
        sa.Column("relative_impact_root", sa.Float(), nullable=False),
        sa.Column("marginal_contribution_root", sa.Float(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
        schema="analysis_store",
    )
    op.create_table(
        ...
        sa.Column("comparison_end_date", sa.Date(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
        schema="analysis_store",
    )
    op.create_table(
...
def downgrade() -> None:
    ...
    op.drop_table("componentdriftrequest", schema="analysis_store")
    op.drop_table("componentdrift", schema="analysis_store")
    op.drop_table("component", schema="analysis_store")
    # ### end Alembic commands ###
