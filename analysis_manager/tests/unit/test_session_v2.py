"""Tests for Session v2 implementation in analysis_manager."""
...
def test_db_stats_endpoint_includes_session_count():
    ...
    mock_manager = MagicMock()
    mock_manager.current_session_count = 3
    ...
    with patch("analysis_manager.db.config.get_session_manager", return_value=mock_manager), patch(
        "analysis_manager.core.dependencies.oauth2_auth"
    ) as mock_oauth:
        ...
        try:
            ...
            response = client.get("/analysis/v1/db-stats")
