...
from analysis_manager.db.config import open_async_session as analysis_manager_session
...
from query_manager.db.config import open_async_session as query_manager_session
...
async def fetch_pattern_data(
    ...
    try:
        ...
        async with query_manager_session("tasks_manager") as session:
...
async def get_pattern_config(pattern: str) -> PatternConfig:
    ...
    try:
        ...
        async with analysis_manager_session("tasks_manager") as session:
